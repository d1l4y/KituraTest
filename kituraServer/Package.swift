...
let package = Package(
    ...
    targets: [
      ...
      .target(name: "Application", dependencies: [ "Kitura", "HeliumLogger", "CloudEnvironment","SwiftMetrics", "Health", "KituraOpenAPI", "SwiftKueryORM", "SwiftKueryPostgreSQL",

      ]),

      .testTarget(name: "ApplicationTests" , dependencies: [.target(name: "Application"), "Kitura", "HeliumLogger", "KituraOpenAPI", "SwiftKueryORM", "SwiftKueryPostgreSQL", ])
    ]
)
